<aside x-transaction {{ $attributes->merge(['class' => 'transform transition-all']) }} aria-label="Sidebar">
    <div class="h-full pt-4 overflow-y-auto md:px-4 bg-slate-100 dark:bg-gray-800">
        ...
        <ul class="space-y-1 font-medium text-base mb-[4rem]">
            ...
            <li>
                <a href="#"
                    class="flex items-center h-[2.7rem] p-2 text-gray-900 bg-white rounded-xl shadow-sm border dark:text-white hover:bg-white dark:hover:bg-gray-700 group">
                    <svg class="w-5 h-5 text-gray-900 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                    ...
                    <span class="ms-3" :class="!open ? 'hidden' : ''">Dashboard</span>
                </a>
            </li>
            ...
            <li>
                <a href="tables"
                    class="flex items-center h-[2.7rem] p-2 text-gray-900 rounded-lg dark:text-white hover:bg-white dark:hover:bg-gray-700 group">
                    ...
                    <span class="ms-3" :class="!open ? 'hidden' : ''">Tables</span>
                </a>
            </li>
            ...
            {{-- <li>
                <button type="button"
                    ...
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 shrink-0 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
            ...
            <li>
                <a href="#"
                    class="flex items-center h-[2.7rem] p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap" :class="!open ? 'hidden' : ''">Kanban</span>
                    {{-- <span
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap" :class="!open ? 'hidden' : ''">Inbox</span>
        ...
        <div class="fixed bottom-0 left-0 z-50 w-full">
            <div class="w-full h-5 pointer-events-none bg-gradient-to-t from-slate-100 via-slate-100/50 to-slate-100/0">
            </div>
            <div class="flex items-center justify-between h-[3.2rem] ml-4 pb-4 px-2 bg-slate-100">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="mt-2 mr-2" :class="!open ? 'hidden' : ''">
