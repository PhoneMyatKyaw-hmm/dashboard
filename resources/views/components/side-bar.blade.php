<aside x-transaction {{ $attributes->merge(['class' => 'transform transition-all']) }}
    aria-label="Sidebar">
    <div class="h-full md:px-4 pt-4 overflow-y-auto bg-slate-100 dark:bg-gray-800">
        ...
        <div class="w-full fixed bottom-0 left-0 z-50">
            <div
                class="h-5 w-full pointer-events-none bg-gradient-to-t from-slate-100 via-slate-100/50 to-slate-100/0">
            </div>
