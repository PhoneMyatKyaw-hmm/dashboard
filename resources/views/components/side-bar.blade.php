...
{{-- <button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
 ...
 <aside x-show="open" x-transaction 
      {{-- x-transition:enter="translate-x-0 duration-500"
      x-transition:leave="transition duration-1000" --}}
      {{ $attributes->merge(['class' => 'transform transition-all']) }} aria-label="Sidebar">
    <div class="h-full md:px-3 py-4  overflow-y-auto bg-gray-50 dark:bg-gray-800">
...
{{-- <aside x-show="!open" 
   x-transition
   class="sticky top-0 left-0 z-40 w-16 h-screen transition-transform -translate-x-full md:translate-x-0" aria-label="Sidebar">
